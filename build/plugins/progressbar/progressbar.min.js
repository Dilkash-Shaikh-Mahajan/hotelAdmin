	...
	})(
		{
						...
						var b = this || Function('return this')(),
							e = (function () {
								...
								return (
									...
									(n.prototype.setScheduleFunction =
										function (a) {
											this._scheduleFunction =
												a;
										}),
			...
			3: [
				function (a, b, c) {
					...
					(f.prototype = new d()),
						(f.prototype.constructor = f),
						(f.prototype._initializeSvg = function (
							a,
							b,
						) {
							a.setAttribute(
			...
			5: [
				function (a, b, c) {
					...
					(g.prototype.value = function () {
						...
						(g.prototype._getComputedDashOffset =
							function () {
						...
						(g.prototype._progressToOffset = function (
							a,
						) {
							var b = this.path.getTotalLength();
							return b - a * b;
						}),
						(g.prototype._resolveFromAndTo = function (
							a,
							b,
							c,
						) {
						...
						(g.prototype._calculateTo = function (
							a,
							b,
						) {
							return d.interpolate(
			...
			6: [
				function (a, b, c) {
					...
					(g.prototype = new d()),
						...
						(g.prototype._initializeSvg = function (
							a,
							b,
						) {
							a.setAttribute(
						...
						(g.prototype._initializeTextContainer =
							function (a, b, c) {
								a.text.style &&
									((c.style.top = 'auto'),
									(c.style.bottom = '0'),
						...
						(g.prototype._pathString =
							e.prototype._pathString),
						(g.prototype._trailString =
							e.prototype._trailString),
						(b.exports = g);
				},
					...
					(g.prototype.animate = function (a, b, c) {
						...
						(g.prototype._createSvgView = function (a) {
							...
							(a.trailColor || a.trailWidth) &&
								((c = this._createTrail(a)),
								b.appendChild(c));
							var d = this._createPath(a);
							return (
								b.appendChild(d),
								{ svg: b, path: d, trail: c }
							);
						}),
						(g.prototype._initializeSvg = function (
							a,
						...
						(g.prototype._createPathElement = function (
							a,
							b,
						) {
						...
						(g.prototype._createTextContainer =
							function (a, b) {
								var c =
						...
						(g.prototype._warnContainerAspectRatio =
							function (a) {
